        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(g, h, j, k) {
                ...
                (function() {
                    ...
                    e = z.execEnd;
                    var J = z.fired,
                        K = z.getCustomParameters,
                        ha = z.iwlBootstrap,
                        L = z.piiInvalidated,
                        ia = z.setIWLExtractors,
                        M = z.validateCustomParameters,
                        N = z.validateUrlParameters,
                        ja = z.setESTRules,
                        ka = z.setCCRules,
                        O = z.automaticPageView,
                        la = z.webchatEvent,
                        P = a.getFbeventsModules("SignalsFBEventsCorrectPIIPlacement"),
                        Q = a.getFbeventsModules("SignalsFBEventsProcessEmailAddress"),
                        ma = a.getFbeventsModules("SignalsFBEventsAddGmailSuffixToEmail"),
                        na = a.getFbeventsModules("SignalsFBEventsQE"),
                        oa = a.getFbeventsModules("SignalsFBEventsQEV2"),
                        R = a.getFbeventsModules("signalsFBEventsFeatureGate"),
                        pa = a.getFbeventsModules("SignalsFBEventsExperimentNames"),
                        qa = pa.PROCESS_ADDITIONAL_SHOPIFY_EVENTS,
                        S = p.logError,
                        T = p.logUserError,
                        U = v.global,
                        V = -1,
                        ra = "b68919aff001d8366249403a2544fba2d833084f1ad22839b6310aadacb6a138",
                    ...
                    function Aa(a) {
                        for (var b in a) ta.call(a, b) && (this[b] = a[b]);
                        return this
                    }

                    function Ba() {
                        try {
                            var b = sa.call(arguments);
                            if (U.isLocked() && b[0] !== "consent") {
                    ...
                    function Ca(d) {
                        ...
                        switch (d) {
                            ...
                            case "trackSingleOnly":
                                ...
                                var M = q.validateMetadata(d);
                                M.error && T(M.error);
                                M.warnings && M.warnings.forEach(function(a) {
                                    T(a)
                                });
                                ta.call(X, L) ? X[L].trackSingleOnly = K : T({
                                    metadataValue: d,
                                    pixelID: L,
                            ...
                            case "userData":
                                ...
                                for (var P = 0; P < W.length; P++) {
                                    var Q = W[P],
                                        ma = Y.optIns.isOptedIn(Q.id, "AutomaticMatching"),
                                        na = Y.optIns.isOptedIn(Q.id, "ShopifyAppIntegratedPixel"),
                                        R = D.eval("process_pii_from_shopify");
                                    ma && na && R ? ea(Y, Q, N, la) : T({
                                        invalidParamName: "pixel_id",
                                        invalidParamValue: Q.id,
                                        method: "set",
                                        params: h,
                                        type: "INVALID_FBQ_METHOD_PARAMETER"
                                    })
                                ...
                                break;
                            default:
                                var pa = Y.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                                    qa = pa != null && pa.dataProcessingOptions.includes("LDU"),
                                    S = f[0],
                                    U = f[1];
                    ...
                    function Da(a, b, c) {
                        try {
                            ...
                            e && a && (f = ga(b || {}));
                            a = null;
                            b != null && (a = i({}, b), b = Q(b), b = P(b), b = ma(b));
                            if (ta.call(X, d)) {
                                b != null && F(X[d].userData) ? (X[d].userData = e ? b || {} : {}, X[d].alternateUserData = e ? a || {} : {}, X[d].censoredUserDataFormat = f, Z.loadPlugin("identity")) : T({
                                    pixelID: d,
                    ...
                    function Ha(b, c, e) {
                        ...
                        try {
                            D.eval("reset_init_time_on_spa_page_change") && f.isAutomaticPageView && (V = V !== -1 ? Date.now() : V);
                            for (var k = 0, l = W.length; k < l; k++) {
                                var m = W[k],
                                    n = Date.now().toString(),
                                    o = g.fbq.instance.pluginConfig.get(m.id, "buffer"),
                                    p = !1;
                                o != null && (p = o.onlyBufferPageView === !0 && na.isInTest("spa_pageview_fix"));
                    ...
                    function Ka(a, b, c) {
                        ...
                        return !R("enable_shopify_additional_events", a) ? !1 : oa.isInTestPageLoadLevelExperiment(qa)
                    }
                    ...
                    function La(a, b, c, d) {
                        ...
                        try {
                            ...
                            e = R("content_type_opt", a);
                            var f = R("enable_product_variant_id", a),
                                h = R("enable_shopify_payment_fields", a);
                            a = R("enable_shopify_search_contents", a);
                    ...
                    function Oa(b, c, e, f, g, h) {
                        ...
                        try {
                            ...
                            var k = b && b.censoredUserDataFormat || {},
                                ...
                                r = {},
                                s = h.em;
                            s != null && $(s) && (p = $(s), p === 1 && (q.em = ra));
                            s = m.em;
                            s != null && $(s) && (p = $(s), p === 1 && (r.em = ra));
                            s = {};
                            var t = o.em;
                            t != null && $(t) && (p = $(t), p === 1 && (s.em = ra));
                            t = {};
                            var u = n.em;
                            u != null && $(u) && (p = $(u), p === 1 && (t.em = ra));
                    ...
                    function Sa() {
                        while (g.fbq.queue && g.fbq.queue.length && !U.isLocked()) {
                            var a = g.fbq.queue.shift();
                            Ba.apply(g.fbq, a)
                        }
                    }
                    U.onUnlocked(function() {
                        Sa()
                    });
                    a.pixelId && (va = !0, Da(a.pixelId));
                    (va && wa || g.fbq !== g._fbq) && T({
