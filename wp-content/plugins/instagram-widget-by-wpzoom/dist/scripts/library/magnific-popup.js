    ...
    h.prototype = {
        ...
        open: function(i) {
            ...
            if (!t.isOpen) {
                ...
                x("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (w(c, (function(e, t, i, n) {
                ...
                return t.isIE7 && (h += " mfp-ie7"), h && t._addClassToMFP(h), t.updateItemHTML(), x("BuildControls"), e("html").css(g), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout((function() {
        ...
        appendContent: function(e, i) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[i] ? t.content.find(".mfp-close").length || t.content.append(I()) : t.content = e : t.content = "", x("BeforeAppend"), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(i) {
            var n, o = t.items[i];
            if (o.tagName ? o = {
            ...
            getInline: function(i, n) {
                if (E(), i.src) {
                    ...
                    if (r.length) {
                        ...
                        a && a.tagName && (_ || (T = o.hiddenClass, _ = b(T), T = "mfp-" + T), S = r.after(_).detach().removeClass(T)), t.updateStatus("ready")
            ...
            getAjax: function(i) {
                ...
                var n = e.extend({
                    ...
                    success: function(n, o, r) {
                        ...
                        x("ParseAjax", a), t.appendContent(e(a.data), O), i.finished = !0, M(), t._setFocus(), setTimeout((function() {
                            t.wrap.addClass(m)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            getImage: function(i, n) {
                var o = 0,
                    r = function() {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, x("ImageLoadComplete")) : 200 > ++o ? setTimeout(r, 100) : a())
                    },
                    a = function() {
